...
- **`schemes/`** – Includes electromechanical schematics (in JPG or PDF format). These diagrams illustrate the complete wiring setup including sensors, motors, controllers, and power management.
